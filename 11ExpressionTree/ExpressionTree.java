public class ExpressionTree{
	...
	ExpressionTree test = new ExpressionTree('-', new ExpressionTree('*', new ExpressionTree('+', new ExpressionTree(5.0), new ExpressionTree( 2.0)), new ExpressionTree(3.33)), new ExpressionTree(1.0));
	System.out.println(test);
	System.out.println(test.toStringPostfix());
	System.out.println(test.toStringPrefix());
